...
export function AnalysisResult({ analysis, feedback, photoPreviewUrl, onNewAnalysis }: { analysis: PhotoAnalysis, feedback: string, photoPreviewUrl: string, onNewAnalysis: () => void }) {
