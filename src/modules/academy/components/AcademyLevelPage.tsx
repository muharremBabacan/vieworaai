...
function PracticeSubmission({ lesson, onFeedbackReady }: { lesson: Lesson, onFeedbackReady: (result: any) => void }) {
    ...
    const handleGetFeedback = async () => {
        ...
        toast({
            ...
            description: "Ödevinize özel geri bildirim hazırlanıyor.",
        });
        ...
        try {
            ...
            toast({
                ...
                description: "Aşağıdan sonucu görebilirsiniz.",
            });
    ...
    return (
        <Card>
            <CardHeader>
                <CardTitle>Pratiğini Göster</CardTitle>
            </CardHeader>
            <CardContent>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        >
                            ...
                            {isDragActive ? (
                                <p className="text-primary">veya sürükleyip bırakın</p>
                            ) : (
                                <p>Yüklemek için tıklayın <span className="text-muted-foreground">veya sürükleyip bırakın</span></p>
                            )}
                        </div>
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            {isCompleted ? (
              <span className="flex items-center gap-2 text-sm font-semibold text-green-500">
                <CheckCircle className="h-4 w-4" /> Bitti
              </span>
            ) : (
            ...
            <div className="flex-1 overflow-y-auto pr-4 -mr-4 space-y-6">
                <Accordion type="multiple" defaultValue={['objective', 'theory']} className="w-full">
                    ...
                    <AccordionItem value="task">
                        <AccordionTrigger>Pratik Görevi</AccordionTrigger>
    ...
    return (
        <div className="container mx-auto">
            <Button variant="ghost" onClick={() => router.push('/academy')} className="mb-4">
                <ArrowLeft className="mr-2 h-4 w-4" /> Akademi'ye Dön
            </Button>
